    ...
    public partial class InitialUpload : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "ID", "AdresaID", "BrojUcesnika", "DatumNad", "IzlicitiranaCena", "Izuzeto", "Krug", "LicitacijaID", "Licitanti", "Opstina", "PeriodZakupa", "PocetnaCena", "PrijavljeniKupci", "StatusNadmetanja", "TipNadmetanja", "VisinaCene", "VremeKraj", "VremePoc" },
                values: new object[,]
                {
                    { new Guid("5d62b2c0-d13c-4f74-840f-ad96bf204d69"), new Guid("6f79d49c-1c14-49b7-94c3-19a81c7f97a0"), 95, new DateTime(2017, 2, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), 34000000, false, 5, new Guid("01724de1-1281-4206-a9ee-a153ba559304"), 39, "ZEDNIK", 28, 400000, 52, "DRUGI_KRUG_STARI", "OTVARANJE_ZATVORENIH_PONUDA", 45698, new DateTime(2019, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2018, 1, 25, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { new Guid("73e131e6-50c4-4ce3-bcb6-b0f9c706f5cb"), new Guid("3aa0344b-57b5-450a-b83a-18c4555be65c"), 95, new DateTime(2022, 8, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), 150000000, true, 7, new Guid("1ecaca89-af8e-47d5-8a33-5f4ec2fcb04e"), 32, "BIKOVO", 67, 1000000, 52, "PRVI_KRUG", "JAVNA_LICITACIJA", 92076, new DateTime(2022, 10, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2022, 9, 6, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { new Guid("abec715b-03e0-4c9a-b97b-327f0af16823"), new Guid("878100df-6973-4292-acb1-0c25b7ac2260"), 18, new DateTime(2012, 5, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), 4900000, true, 3, new Guid("77eb8e4b-ede1-4825-8da2-72d14c2d7259"), 48, "DONJI_GRAD", 55, 45900, 71, "DRUGI_KRUG_NOVI", "JAVNA_LICITACIJA", 55942, new DateTime(2015, 5, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2015, 5, 16, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
