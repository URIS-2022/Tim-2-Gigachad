...
namespace LiceService.DTO
{
	...
	public class KontaktOsobaCreateDTO : IValidatableObject
	{
		...
		/// <summary>
		/// Validacija za model DTO-a za kreiranje entiteta kontakt osoba.
		/// </summary>
		public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
		{
			if (Ime.Equals(Prezime))
				yield return new ValidationResult("Kontakt osoba ne može da ima isto ime i prezime.", new[] { "KontaktOsobaCreateDTO" });
		}
	}
}
